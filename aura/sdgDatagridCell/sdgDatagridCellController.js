                ...
                if (field.isHTMLFormatted) {
                    ...
                    switch (fieldtype) {
                        ...
                        case "SUMMARY":
                            ...
                            break;
                        case "ID":
                            helper.renderHyperLinktoObject(component, datachunkid, datachunkid);
                            break;
                        case "REFERENCE":
                            helper.renderText(component, datachunk);
                            break;
                        ...
                        case "ADDRESS":
                            ...
                            var url = "https://www.google.com/maps/search/?api=1&query=" + encodeURIComponent(label);
                        ...
                        case "CURRENCY":
                            ...
                            if (field.FormattedValue != null) {
                                try {
                                    ...
                                    console.log('unable to render currency');
                                }
                            }
                            break;
                        case "DATE":
                            try {
                                ...
                                if (datachunk) {
                                    if (datachunk != '') {
                                        ...
                                        var datevalue = $A.localizationService.parseDateTime(datachunk);
                                        if (datevalue != 'NaN') {
                                            //var dateoffsetcalc = new Date();
                                            //var offset = dateoffsetcalc.getTimezoneOffset();
                                            //datevalue = datevalue + (offset * 60 * 1000);
                                            if (fieldstyle == 'Age') {
                                                helper.renderText(component, helper.formatDurationDateTime(component, datevalue));
                                            }
                                            else {
                                                //Render this date WITHOUT a timezone
                                                helper.CreateCmp(component,
                                                    "lightning:formattedDateTime",
                                                    { "value": datevalue, year: "numeric", month: "short", day: "numeric" }
                                                );
                                            }
                                        }
                                    }
                            ...
                            try {
                                ...
                                if (datevalue != 'NaN') {
                                    if (fieldstyle == 'Age') {
                                        ...
                                        helper.CreateCmp(component,
                                            "lightning:formattedDateTime",
                                            { "value": datevalue, timeZone: timezone, year: "numeric", month: "short", day: "numeric", hour: "numeric", minute: "numeric", second: "numeric" }
                                        );
                        ...
                        case "DOUBLE":
                            try {
                                ...
                                console.log('unable to render double');
                            }
                            break;
                        case "TEXTAREA":
                            helper.CreateCmp(component,
